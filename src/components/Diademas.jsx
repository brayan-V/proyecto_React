...
const Diademas = ({ agregarAlCarritoClicked }) => {
    const items = [
        ...
        },
        {
            ...
            precio: "$580.000",
            imagenSrc: "/images/BlackShark.png",

...
const Mouse = ({agregarAlCarritoClicked}) =>{
    const items = [
        ...
        },
        {
            ...
            precio: "$500.000",
            imagenSrc: "/images/SteelSeries.png",
